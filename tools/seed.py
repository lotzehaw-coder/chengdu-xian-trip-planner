...
I('lunch-mapo', D[1], 'Lunch — Chen Mapo Tofu 陈麻婆豆腐', 'Chengdu', 'Food', '12:00', '13:15',
  'The original home of mapo tofu. Order some dishes 微辣 (wēi là, mild) or 不辣 (bù là, no chilli) for the kids and elderly.', ('easy', 'spicy'), pic='mapotofu')
...
I('dinner-hotpot', D[1], 'Dinner — Sichuan hot pot 火锅', 'Chengdu', 'Food', '18:30', '20:00',
  'Ask for a 鸳鸯锅 (yuān yāng guō): a split pot with a spicy side and a clear broth side, so the kids and elderly eat from the mild half. Well-known chains: 小龙坎 Xiaolongkan, 蜀九香 Shu Jiu Xiang.', ('spicy', 'indoor'), pic='hotpot')
# Day 2 — Tue 15 Dec
...
I('lunch-longchaoshou', D[2], 'Lunch — Long Chao Shou wontons 龙抄手', 'Chengdu', 'Food', '12:15', '13:15',
  'A Chengdu snack institution on Chunxi Road: wontons in clear or red-oil broth, plus small plates of Chengdu snacks. Gentle food for everyone.', ('easy', 'indoor'), pic='dumplings')
I('rest-d2', D[2], 'Back to the hotel — nap & rest', 'Chengdu', 'Rest', '13:30', '15:45',
  'Early start and a long walk: nap time for the baby and a rest for the elderly before the evening.', ('rest',))
I('dinner-d2', D[2], 'Dinner — Sichuan home cooking', 'Chengdu', 'Food', '19:00', '20:30',
  'e.g. 马旺子 Ma Wang Zi. Mild dishes that work for kids: 宫保鸡丁 kung pao chicken, 回锅肉 twice-cooked pork, 蒜蓉空心菜 garlic greens, 蛋炒饭 egg fried rice.', ('indoor', 'spicy'), pic='mapotofu')
# Day 3 — Wed 16 Dec
...
I('wildgoose', D[3], 'Big Wild Goose Pagoda 大雁塔', "Xi'an", 'Sight', '17:00', '18:15',
...
I('dinner-dapaidang', D[3], "Dinner — Chang'an Da Pai Dang 长安大牌档", "Xi'an", 'Food', '18:30', '19:45',
  "Lively Shaanxi restaurant with the Xi'an classics in one place: roujiamo, biangbiang noodles, liangpi, paomo. Staff in costume; kids love it.", ('indoor',), pic='biangbiang')
...
# Day 7 — Sun 20 Dec
I('dinner-d7', D[7], 'Dinner near the hotel', 'Chengdu', 'Food', '19:00', '20:30', 'An easy one after a big day out.', ('easy', 'indoor'), pic='mapotofu')
...
I('rest-d8', D[8], 'Rest, showers & pack (keep the rooms)', 'Chengdu', 'Rest', '14:00', '17:30',
  'The flight leaves after midnight. Keep the rooms until evening (late check-out, or book the night of 21 Dec) so the baby naps and everyone showers before the airport.', ('rest',))
...
I('earlynight', D[1], 'Early night: jet-lag recovery', 'Chengdu', 'Rest', '20:15', '', 'We landed at 1am. Bath, bed.', ('rest',), opt='d-d1eve:rest', pic='peoplespark')
DEC('d-d1eve', D[1], '20:00', 'Monday evening', 'After hot pot on the first night, what next?', [
  ...
  O('rest', 'Early night', 'Chengdu', 'We land at 1am the night before. Sleep wins.', ('rest',), 'peoplespark', ['earlynight'])])
...
I('pool-d2', D[2], 'Hotel pool, lounge & free time', 'Chengdu', 'Rest', '16:00', '18:30', "Swim, tea, naps. Save energy for Xi'an.", ('rest',), opt='d-d2pm:rest', pic='ifspanda')
DEC('d-d2pm', D[2], '16:00', 'Tuesday late afternoon', 'After the pandas and a nap:', [
  ...
  O('rest', 'Pool & lounge', 'Chengdu', 'A quiet afternoon at the hotel.', ('rest',), 'ifspanda', ['pool-d2'])])
...
I('rest-d4', D[4], 'Back to the hotel to rest', "Xi'an", 'Rest', '14:00', '17:30', 'The Terracotta Army is a long morning on foot. Warm up and nap.', ('rest',), opt='d-d4pm:rest', pic='dumplings')
DEC('d-d4pm', D[4], '14:00', 'Thursday afternoon', 'After the Terracotta Army:', [
  ...
  O('rest', 'Hotel & rest', "Xi'an", 'Head back, warm up and nap before the dumpling dinner.', ('rest',), 'dumplings', ['rest-d4'])])
...
I('tangshow', D[5], 'Tang Dynasty dinner & show 唐乐宫', "Xi'an", 'Show', '18:30', '21:00',
  'Seated dinner with a big costumed Tang-court music and dance show. Warm, comfortable, no walking.', ('indoor', 'easy', 'book'), opt='d-d5eve:tang', book='Book a few days ahead on Trip.com.')
...
I('hanfu', D[6], 'Tang costume family photoshoot 唐装 · 汉服', "Xi'an", 'Show', '09:00', '11:30',
  'Rent Tang-style robes (with hair and make-up) near the Big Wild Goose Pagoda and take family portraits. Kids\' sizes available.', ('easy', 'book'), opt='d-d6am:hanfu', book='Book a studio 1–2 days ahead; allow 2–3h.')
...
I('slow-d6', D[6], 'Slow morning, brunch & pack', "Xi'an", 'Rest', '09:30', '11:30', 'Lie-in before the train.', ('rest',), opt='d-d6am:slow', pic='wildgoose')
DEC('d-d6am', D[6], '09:30', 'Saturday morning', 'Before the afternoon train back to Chengdu:', [
  O('hanfu', 'Tang costume family photos', "Xi'an", 'Dress up in Tang robes for portraits by the pagoda. A keepsake for all 10.', ('easy', 'book'), 'hanfu', ['hanfu']),
  O('goose', 'Small Wild Goose Pagoda', "Xi'an", 'Peaceful garden and free museum.', ('stroller', 'easy'), 'smallgoose', ['smallgoose']),
  O('slow', 'Slow morning', "Xi'an", 'Sleep in, brunch, pack.', ('rest',), 'wildgoose', ['slow-d6'])])

I('leshan-train', D[7], 'G-train Chengdu East → Leshan 乐山', 'Chengdu', 'Travel', '08:30', '09:40', 'About 1 hour, then 30 min by van to the river pier.', ('book',), opt='d-d7:leshan', pic='hsr', key='leshanstn',
  book='Train tickets open 15 days ahead (from Sat 5 Dec).')
...
DEC('d-d7', D[7], '09:00', 'Sunday: the big one', 'Pick the whole day:', [
  O('leshan', 'Leshan Giant Buddha', 'Chengdu', 'Day trip by 1h fast train. See the 71m cliff Buddha from a boat, no stairs needed.', ('cold', 'book'), 'leshan', ['leshan-train', 'leshan']),
...
I('wenshu', D[8], 'Wenshu Monastery & vegetarian lunch 文殊院', 'Chengdu', 'Sight', '10:30', '12:30',
  "Chengdu's busiest Buddhist temple: incense, quiet courtyards and a well-known vegetarian restaurant inside.", ('stroller', 'easy'), opt='d-d8am:wenshu')
...
I('pool-d8', D[8], 'Pool & slow morning', 'Chengdu', 'Rest', '10:30', '12:30', 'Rest up before the overnight flight.', ('rest',), opt='d-d8am:rest', pic='chengduhero')
DEC('d-d8am', D[8], '10:30', 'Monday morning', 'Last morning (most museums are closed on Mondays):', [
  O('wenshu', 'Wenshu Monastery', 'Chengdu', 'Temple courtyards and a vegetarian lunch.', ('stroller', 'easy'), 'wenshu', ['wenshu']),
  O('shop', 'Shopping at IFS & Chunxi Rd', 'Chengdu', 'Souvenirs, tea, Sichuan pepper.', ('stroller', 'indoor'), 'ifspanda', ['shopping']),
  O('rest', 'Pool & slow morning', 'Chengdu', 'Save energy for the 1am flight.', ('rest',), 'chengduhero', ['pool-d8'])])

# ---------- ideas: not on a day; heart the ones you want ----------
I('tianfu-idea', '', 'Tianfu Square & Chunxi Road 天府广场', 'Chengdu', 'Shop', info='The central square and main shopping street, walkable from the central Marriott hotels.', fam=('stroller', 'easy'), pic='chunxi', key='tianfusquare')
...
B('h1in', D[0], 'hotel', 'Check in: {hotel}', '01:30', sort='25:30', tentative=True, note="book this room from Sun 13 Dec so it's held for a 1:30am arrival")
...
B('g1', D[3], 'train', "G-train Chengdu East → Xi'an North", '11:30', key='cdeast', tentative=True, **{'from': 'Chengdu East 成都东', 'to': "Xi'an North 西安北"},
  note='about 3h10–3h40 · not booked · tickets open 15 days ahead (Tue 1 Dec) · First or Business class for the grandparents · under-6s ride free without a seat')
B('x1', D[3], 'car', "Vans to the Xi'an hotel", '15:15', key='xianN', note='about 40 min to Qujiang')
B('h2in', D[3], 'hotel', 'Check in: {hotel}', '16:00', tentative=True)
...
B('g2', D[6], 'train', "G-train Xi'an North → Chengdu East", '14:00', key='xianN', tentative=True, **{'from': "Xi'an North 西安北", 'to': 'Chengdu East 成都东'},
  note='about 3h10–3h40 · tickets open Fri 4 Dec')
...
prep = [
 ...
 ['Fri 4 Dec', "Train back Xi'an → Chengdu for Sat 19 Dec."],
 ['Sat 5 Dec', 'Leshan train for Sun 20 Dec, if Leshan wins the vote.'],
